...
$REPO_ROOT/data/templates/template_engine.py -d $REPO_ROOT/data/$BUILD_LOCATION/$BUILD_DATA_CENTER/build.yaml -i $REPO_ROOT/data/templates/bootstrap/common/cepheus_build_update.sh.j2 -o $REPO_ROOT/bootstrap/common/cepheus_build_update.sh
...
$REPO_ROOT/data/templates/template_engine.py -d $REPO_ROOT/data/$BUILD_LOCATION/$BUILD_DATA_CENTER/build.yaml -i $REPO_ROOT/data/templates/bootstrap/common/cepheus_bootstrap_init.sh.j2 -o $REPO_ROOT/bootstrap/common/cepheus_bootstrap_init.sh
...
$REPO_ROOT/data/templates/template_engine.py -d $REPO_ROOT/data/$BUILD_LOCATION/$BUILD_DATA_CENTER/build.yaml -i $REPO_ROOT/data/templates/bootstrap/common/cepheus_backup_rsync.sh.j2 -o $REPO_ROOT/bootstrap/common/cepheus_backup_rsync.sh
