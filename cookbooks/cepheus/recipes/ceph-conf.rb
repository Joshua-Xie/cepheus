...
node.default['ceph']['radosgw']['keystone']['auth'] = node['cepheus']['openstack']['keystone']['radosgw']['enable']
node.default['ceph']['radosgw']['keystone']['accepted_roles'] = node['cepheus']['openstack']['keystone']['radosgw']['accepted_roles']
node.default['ceph']['radosgw']['keystone']['token_cache_size'] = node['cepheus']['openstack']['keystone']['radosgw']['token_cache_size']
node.default['ceph']['radosgw']['keystone']['revocation_interval'] = node['cepheus']['openstack']['keystone']['radosgw']['revocation_interval']
node.default['ceph']['radosgw']['keystone']['admin']['token'] = node['cepheus']['openstack']['keystone']['radosgw']['admin']['token']
node.default['ceph']['radosgw']['keystone']['admin']['url'] = node['cepheus']['openstack']['keystone']['radosgw']['admin']['url']
node.default['ceph']['radosgw']['keystone']['admin']['port'] = node['cepheus']['openstack']['keystone']['radosgw']['admin']['port']
